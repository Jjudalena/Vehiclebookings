        ...
        ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="u_dest">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Courses </label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="u_course">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Department </label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="u_dept">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Purpose </label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="u_purp">
            </div>
